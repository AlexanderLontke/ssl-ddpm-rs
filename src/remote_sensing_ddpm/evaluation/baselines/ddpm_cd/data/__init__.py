...
def create_image_dataset(dataset_opt, phase):
    ...
    from remote_sensing_ddpm.evaluation.baselines.ddpm_cd.data.ImageDataset import (
        ImageDataset as D,
    )
...
def create_cd_dataset(dataset_opt, phase):
    """create dataset"""
    mode = dataset_opt["mode"]
    from remote_sensing_ddpm.evaluation.baselines.ddpm_cd.data.CDDataset import (
        CDDataset as D,
    )
...
def create_uc_merced_classification_dataset(dataset_opt, phase):
